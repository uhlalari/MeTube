...
class VideoAdapter(
    ...
    private fun updateFavoriteIcon(holder: ViewHolder, video: Video) {
        if (isFavorite(video)) {
            ...
            holder.binding.btnFavorite.setImageResource(R.drawable.ic_favorite_outline)
        }
    }
    ...
    private fun updatePlaylistIcon(holder: ViewHolder, video: Video) {
        if (isInPlaylist(video)) {
            holder.binding.btnAddToList.setImageResource(R.drawable.ic_playlist_on)
        } else {
            holder.binding.btnAddToList.setImageResource(R.drawable.ic_playlist_off)
        }
    }
